export const resources = {
  en: {
    translation: {
      appName: 'Skills Hub',
      subtitle: 'Manage Gemini CLI skills',
      nav: {
        mySkills: 'My Skills',
        discover: 'Discover',
      },
      discover: {
        ...
        emptyHint: 'Search for skills from skills.sh',
        import: 'Import',
        install: 'Install',
        importSuccess: '{{name}} installed successfully',
        importFailed: 'Installation failed',
        multiSkills: 'Repository contains multiple skills, please import via Add Skill',
      ...
      syncAllToTools: 'Sync to all installed tools',
      unsyncAllFromTools: 'Remove sync from all tools',
      ...
      errors: {
        ...
        noSkillsFoundGit: 'No skills found in this repository (SKILL.md not detected).',
        multiSkillsRepo: 'This repository contains multiple skills. Please provide a folder URL to a specific skill.',
        allSkillsExist: 'All skills in this repository are already installed.',
      ...
      actions: {
        ...
        syncingAll: 'Syncing {{name}} to all tools...',
        unsyncingAll: 'Unsyncing {{name}} from all tools...',
      },
      status: {
        ...
        syncAllCompleted: 'Synced to all tools.',
        unsyncAllCompleted: 'Removed from all tools.',
        noChangesNeeded: 'No changes needed.',
        syncPartialFailed: '{{success}} succeeded, {{error}} failed.',
      },
      relative: {
        empty: '—',
        justNow: 'just now',
      ...
      skillDetail: {
        ...
        noContent: 'No SKILL.md content available',
      },
      delete: {
  ...
  zh: {
    translation: {
      ...
      discover: {
        ...
        search: '搜索',
        searching: '搜索中...',
        noResults: '未找到相关 Skills',
        searchFailed: '搜索失败',
        emptyHint: '从 skills.sh 搜索 Skills',
        import: '导入',
        install: '安装',
        importSuccess: '{{name}} 安装成功',
        importFailed: '安装失败',
        multiSkills: '仓库包含多个 Skills，请通过「添加 Skill」导入',
        poweredBy: 'Powered by',
      ...
      syncAll: '全部同步',
      unsyncAll: '全部取消',
      syncAllToTools: '同步到所有已安装的工具',
      unsyncAllFromTools: '从所有工具取消同步',
      ...
      errors: {
        ...
        noSkillsFoundGit: '未在该仓库中发现可导入的 Skills（未找到 SKILL.md）。',
        multiSkillsRepo: '该仓库包含多个 Skills，请提供具体 Skill 文件夹的 URL 链接。',
        allSkillsExist: '该仓库中的所有 Skills 均已安装。',
      ...
      actions: {
        ...
        syncingAll: '同步 {{name}} 到所有工具...',
        unsyncingAll: '从所有工具取消 {{name}} ...',
      },
      status: {
        ...
        syncAllCompleted: '已同步到所有工具。',
        unsyncAllCompleted: '已从所有工具取消同步。',
        noChangesNeeded: '无需更改。',
        syncPartialFailed: '{{success}} 成功，{{error}} 失败。',
      },
      relative: {
        empty: '—',
        justNow: '刚刚',
